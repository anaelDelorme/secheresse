...
st.markdown(
    """Cette carte présente l'ensemble des arrêtés de sécheresse à la date de jour sur les eaux sousterraines. Les arrêtés de sécheresse ont 4 niveaux d'alerte :      
